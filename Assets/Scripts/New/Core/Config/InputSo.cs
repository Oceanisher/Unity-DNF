...
namespace New.Core.Config
{
    ...
    public class InputSo : ScriptableObject
    {
        ...
        private void SetMapFight()
        {
            ...
            {
                _townKeyMap.Add(skill1, KeyType.Skill1);
            }
            if (KeyCode.None != skill2)
            {
                _townKeyMap.Add(skill2, KeyType.Skill2);
            }
            if (KeyCode.None != skill3)
            {
                _townKeyMap.Add(skill3, KeyType.Skill3);
            }
            if (KeyCode.None != skill4)
            {
                _townKeyMap.Add(skill4, KeyType.Skill4);
            }
            if (KeyCode.None != skill5)
            {
                _townKeyMap.Add(skill5, KeyType.Skill5);
            }
            if (KeyCode.None != skill6)
            {
                _townKeyMap.Add(skill6, KeyType.Skill6);
            }
            if (KeyCode.None != skill7)
            {
                _townKeyMap.Add(skill7, KeyType.Skill7);
            }
            if (KeyCode.None != skill8)
            {
                _townKeyMap.Add(skill8, KeyType.Skill8);
            }
            if (KeyCode.None != skill9)
            {
                _townKeyMap.Add(skill9, KeyType.Skill9);
            }
        }
    }
}